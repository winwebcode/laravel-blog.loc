...
Комментарии
Подписки (пока без рассылки)
Вывод постов, предыдущий/следующий пост
Пагинация
SEO (title / description / keywords)
Регистрация / авторизация
Файловое кэширование (очистка кэша в админке раздел настройки)

Админка:
CRUD для пользователей / комментариев / категорий / тегов / постов
Бан пользователей
Одобрение / блокировка комментариев
Отключение формы комментариев (уже одобренные комментарии остаются)
