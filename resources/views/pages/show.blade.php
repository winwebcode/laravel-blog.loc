@extends('layout') //include /views/admin/layout.blade.php
                ...
                <article class="post">
                    ...
                    <div class="post-content">
                        ...
                        <div class="social-share">
							<span
                                class="social-share-title pull-left text-capitalize">By {{$post->getAuthor()}} On {{$post->getDate()}}</span>
